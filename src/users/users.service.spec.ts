...
describe('UserService', () => {
  ...
  describe('createAccount', () => {
    ...
    it('should create a new user', async () => {
      ...
      expect(usersRepository.create).toHaveBeenCalledTimes(
        1
      )
      ...
      expect(
        verificationsRepository.create
  ...
  describe('login', () => {
    ...
    it('should fail if user does not exist', async () => {
      ...
      expect(usersRepository.findOne).toHaveBeenCalledTimes(
        1
      )
  ...
  describe('editProfile', () => {
    it('should change email', async () => {
      ...
      expect(
        verificationsRepository.save
      ).toHaveBeenCalledWith(newVerification)
  ...
  describe('verifyEmail', () => {
    it('should verify email', async () => {
      ...
      expect(
        verificationsRepository.findOne
      ).toHaveBeenCalledTimes(1)
      expect(
        verificationsRepository.findOne
      ).toHaveBeenCalledWith(
      ...
      expect(
        verificationsRepository.delete
      ).toHaveBeenCalledTimes(1)
      expect(
        verificationsRepository.delete
      ).toHaveBeenCalledWith(mockedVerification.id)
      expect(result).toEqual({ ok: true })
    })
